...
Usar minúsculas para los nombres de los elementos HTML, como `<p>, <h1>, <section>, etc".`
Cerrar siempre los elementos HTML, por ejemplo, `<p> </p>.`
Colocar entre comillas los atributos de los elementos HTML, por ejemplo, `<p class="name"></p>.`
...
1. Sección Menú Navegación
   ...
   <img alt="Menu_navegacion_sprint1" src="src/assets/img-menu.png">

2. Sección Nuestros Servicios

    <img alt="Servicios_sprint_1" src="src/assets/img-servicios.png">

3. Sección Nuestros Proyectos

    <img alt="Proyectos_sprint1" src="src/assets/img-proyectos.png">
...
1.
 <img alt="Inicio" src="src/assets/img-inicio.png">

2.
 <img alt="Servicios" src="src/assets/img-servicios.png">

3.
 <img alt="Proyectos" src="src/assets/img-proyectos.png">
